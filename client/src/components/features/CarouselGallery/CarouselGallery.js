...
const CarouselGallery = () => {
  ...
  const slides = [
    <a href="/products/8d3dcd52-e923-4b57-8821-5a040fb3f51d">
      <img
        src={`${process.env.PUBLIC_URL}/images/carousel/theodore1.png`}
        alt="john theodore"
    ...
    <a href="/products/337ae709-ddb4-4e3f-bfc0-0eb1ff52682a">
      <img
        src={`${process.env.PUBLIC_URL}/images/carousel/chad2.png`}
        alt="chad smiths"
        className={styles.img}
      />
    </a>,
    <a href="/products/32b311a7-7173-48a0-ade6-e9e8effcc91b">
      <img
        src={`${process.env.PUBLIC_URL}/images/carousel/hawkins.png`}
        alt="taylor hawkins"
        className={styles.img}
      />
    </a>,
